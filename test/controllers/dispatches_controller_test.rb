...
class DispatchesControllerTest < ActionController::TestCase
  ...
  test "should create dispatch" do
    assert_difference('Dispatch.count') do
      post :create, dispatch: { advance: @dispatch.advance, balance: @dispatch.balance, loadOrder: @dispatch.loadOrder, manifestNumber: @dispatch.manifestNumber }
    end
  ...
  test "should update dispatch" do
    patch :update, id: @dispatch, dispatch: { advance: @dispatch.advance, balance: @dispatch.balance, loadOrder: @dispatch.loadOrder, manifestNumber: @dispatch.manifestNumber }
    assert_redirected_to dispatch_path(assigns(:dispatch))
  end
