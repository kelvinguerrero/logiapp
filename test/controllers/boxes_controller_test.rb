...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { incomeDate: @box.incomeDate, name: @box.name, total: @box.total, value: @box.value }
    end
  ...
  test "should update box" do
    patch :update, id: @box, box: { incomeDate: @box.incomeDate, name: @box.name, total: @box.total, value: @box.value }
    assert_redirected_to box_path(assigns(:box))
  end
