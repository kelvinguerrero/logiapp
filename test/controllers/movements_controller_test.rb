...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { concept: @movement.concept, movementDate: @movement.movementDate, value: @movement.value }
    end
  ...
  test "should update movement" do
    patch :update, id: @movement, movement: { concept: @movement.concept, movementDate: @movement.movementDate, value: @movement.value }
    assert_redirected_to movement_path(assigns(:movement))
  end
