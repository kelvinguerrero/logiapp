...
class ConceptsControllerTest < ActionController::TestCase
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post :create, concept: { container: @concept.container, description: @concept.description, route: @concept.route }
    end
  ...
  test "should update concept" do
    patch :update, id: @concept, concept: { container: @concept.container, description: @concept.description, route: @concept.route }
    assert_redirected_to concept_path(assigns(:concept))
  end
